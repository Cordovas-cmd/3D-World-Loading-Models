...
// Imports a specific loader we need for the format for models.
...
class BasicCharacterControls {
    ...
    class LoadModelDemo {
      ...
      _Initialize() {
        ...
        this._LoadAnimatedModelAndPlay(
            './resources/dancer/', 'dancer.fbx', 'Silly Dancing.fbx', new THREE.Vector3(30, 0, -10));
        this._LoadAnimatedModelAndPlay(
...
// class LoadModelDemoDemo {
//     constructor() {
//         this._Initialize();
//     }
//     _Initialize() {
//         //sets up web gl renderer. with parameters to enable shadows and stuff. specify size.
//         this._threejs = new THREE.WebGLRenderer({
//             antialias: true,
//         });
//         this._threejs.shadowMap.enabled = true;
...
// // cube texture assignment and loading CUBE MAPPING. 6 sides one for each face sample using direction vector.
//           const loader = new THREE.CubeTextureLoader();
//           const texture = loader.load([
//               './resources/posx.jpg',
//               './resources/negx.jpg',
...
//     //Request animation frame / render function
